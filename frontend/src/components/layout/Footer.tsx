    ...
    <footer className="bg-primary text-primary-foreground mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/shop?category=women" className="hover:text-gold transition-smooth">
                  Women's Fragrances
                </Link>
              </li>
              <li>
                <Link to="/shop?category=men" className="hover:text-gold transition-smooth">
                  Men's Fragrances
                </Link>
              </li>
              <li>
                <Link to="/shop?category=unisex" className="hover:text-gold transition-smooth">
                  Unisex Collection
                </Link>
              </li>
              <li>
                <Link to="/shop" className="hover:text-gold transition-smooth">
                  Best Sellers
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-primary-foreground/20 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/80">
          <p>© 2024 ScentHaven. All rights reserved.</p>
